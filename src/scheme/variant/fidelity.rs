...
mod tests {
    ...
    fn test_light_theme_min_contrast_primary() {
        let scheme =
            SchemeFidelity::new(Argb::from_u32(0xff0000ff).into(), false, Some(-1.0)).scheme;
    ...
    fn test_light_theme_min_contrast_objectionable_tertiary_container_lightens() {
        let scheme =
            SchemeFidelity::new(Argb::from_u32(0xff850096).into(), false, Some(-1.0)).scheme;
    ...
    fn test_light_theme_standard_contrast_objectionable_tertiary_container_lightens() {
        let scheme =
            SchemeFidelity::new(Argb::from_u32(0xff850096).into(), false, Some(0.0)).scheme;
    ...
    fn test_dark_theme_min_contrast_primary() {
        let scheme =
            SchemeFidelity::new(Argb::from_u32(0xff0000ff).into(), true, Some(-1.0)).scheme;
